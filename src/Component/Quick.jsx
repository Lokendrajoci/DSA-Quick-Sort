...
import { ChevronRight, RotateCcw, BookOpen, Code } from "lucide-react";
  ...
  const renderStep = () => {
    ...
    switch (step.type) {
      case "partition-start":
        description = `Starting partition with pivot element ${
        ...
        break;
      case "comparing-left":
        description = `Looking for element greater than pivot ${
          step.array[step.pivot]
        } from left`;
        indices = `Pivot Index: ${step.pivot}, i: ${step.i}, j: ${step.j}`;
        partitionInfo = `Level: ${step.level}`;
      ...
      case "comparing-right":
        description = `Looking for element smaller than pivot ${
          step.array[step.pivot]
        } from right`;
        indices = `Pivot Index: ${step.pivot}, i: ${step.i}, j: ${step.j}`;
        partitionInfo = `Level: ${step.level}`;
      ...
      case "swap":
        description = `Swapping elements ${
          step.array[step.swapIndices[0]]
        } and ${step.array[step.swapIndices[1]]}`;
        indices = `Pivot Index: ${step.pivot}, i: ${step.i}, j: ${step.j}`;
        partitionInfo = `Level: ${step.level}`;
        break;
      case "pivot-placement":
        description = `Placing pivot ${
          step.array[step.pivot]
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg space-y-2">
          ...
          <div className="text-xs text-gray-600 dark:text-gray-400 mt-2">
            ...
            indices are highlighted above the array
          </div>
        </div>
      </div>
    );
    ...
    <Card id="whyQuickSort" className="p-6 mb-6">
      ...
      <div className="space-y-4 text-gray-800 dark:text-gray-200">
        ...
        <div>
          ...
          <p>
            Unlike Merge Sort, QuickSort is an in-place sorting algorithm,
        ...
        <div>
          ...
          <p>
            QuickSort is cache-friendly as it works with contiguous blocks of
            memory.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p>O(log n)</p>
          <p className="mt-2">
            QuickSort requires less additional space compared to Merge Sort,
        ...
        <Card className="p-6 mb-6">
              ...
              <Button
                onClick={() => {
                  ...
                  if (!showPseudocode) {
                    setTimeout(() => {
                      document
                        .getElementById("quickSortPseudocode")
                        ?.scrollIntoView({ behavior: "smooth" });
                    }, 100);
                  }
                }}
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-2">
              ...
              />
              <Button onClick={handleCustomArraySubmit}>
                Set Custom Array
              </Button>
            </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-4">
            ...
            {!isRunning && (
              <Button onClick={prepareQuickSort}>Start Quick Sort</Button>
            )}
